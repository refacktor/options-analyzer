...
public class OptionChain {
    ...
    public String toString() {
        ...
        sb.append(OptionChain.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("result");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OptionChain) == false) {
            return false;
        }
        OptionChain rhs = ((OptionChain) other);
